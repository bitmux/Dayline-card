...
`,mt=2;class vt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,a){this._$Ct=t,this._$AM=e,this._$Ci=a}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}class wt extends vt{constructor(t){if(super(t),this.it=G,t.type!==mt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===G||null==t)return this._t=void 0,this.it=t;if(t===Z)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}wt.directiveName="unsafeHTML",wt.resultType=1;class _t extends wt{}_t.directiveName="unsafeSVG",_t.resultType=2;const yt=(t=>(...e)=>({_$litDirective$:t,values:e}))(_t),bt={"calendar-days":'<path d="M8 2v3" /> <path d="M16 2v3" /> <rect x="3" y="3" width="18" height="18" rx="2" /> <path d="M3 9h18" /> <path d="M8 13h.01" /> <path d="M12 13h.01" /> <path d="M16 13h.01" /> <path d="M8 17h.01" /> <path d="M12 17h.01" /> <path d="M16 17h.01" />',sparkles:'<path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z" /> <path d="M20 2v4" /> <path d="M22 4h-4" /> <circle cx="4" cy="20" r="2" />',info:'<circle cx="12" cy="12" r="10" /> <path d="M12 16v-4" /> <path d="M12 8h.01" />',"triangle-alert":'<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3" /> <path d="M12 9v4" /> <path d="M12 17h.01" />',"wifi-off":'<path d="M12 20h.01" /> <path d="M8.5 16.429a5 5 0 0 1 7 0" /> <path d="M5 12.859a10 10 0 0 1 5.17-2.69" /> <path d="M19 12.859a10 10 0 0 0-2.007-1.523" /> <path d="M2 8.82a15 15 0 0 1 4.177-2.643" /> <path d="M22 8.82a15 15 0 0 0-11.288-3.764" /> <path d="m2 2 20 20" />',check:'<path d="M20 6 9 17l-5-5" />',sun:'<circle cx="12" cy="12" r="4" /> <path d="M12 2v2" /> <path d="M12 20v2" /> <path d="m4.93 4.93 1.41 1.41" /> <path d="m17.66 17.66 1.41 1.41" /> <path d="M2 12h2" /> <path d="M20 12h2" /> <path d="m6.34 17.66-1.41 1.41" /> <path d="m19.07 4.93-1.41 1.41" />',moon:'<path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401" />',cloud:'<path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z" />',cloudy:'<path d="M17.5 12a1 1 0 1 1 0 9H9.006a7 7 0 1 1 6.702-9z" /> <path d="M21.832 9A3 3 0 0 0 19 7h-2.207a5.5 5.5 0 0 0-10.72.61" />',"cloud-sun":'<path d="M12 2v2" /> <path d="m4.93 4.93 1.41 1.41" /> <path d="M20 12h2" /> <path d="m19.07 4.93-1.41 1.41" /> <path d="M15.947 12.65a4 4 0 0 0-5.925-4.128" /> <path d="M13 22H7a5 5 0 1 1 4.9-6H13a3 3 0 0 1 0 6Z" />',"cloud-rain":'<path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242" /> <path d="M16 14v6" /> <path d="M8 14v6" /> <path d="M12 16v6" />',"cloud-drizzle":'<path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242" /> <path d="M8 19v1" /> <path d="M8 14v1" /> <path d="M16 19v1" /> <path d="M16 14v1" /> <path d="M12 21v1" /> <path d="M12 16v1" />',"cloud-snow":'<path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242" /> <path d="M8 15h.01" /> <path d="M8 19h.01" /> <path d="M12 17h.01" /> <path d="M12 21h.01" /> <path d="M16 15h.01" /> <path d="M16 19h.01" />',"cloud-lightning":'<path d="M6 16.326A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 .5 8.973" /> <path d="m13 12-3 5h4l-3 5" />',"cloud-fog":'<path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242" /> <path d="M16 17H7" /> <path d="M17 21H9" />',"cloud-hail":'<path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242" /> <path d="M16 14v2" /> <path d="M8 14v2" /> <path d="M16 20h.01" /> <path d="M8 20h.01" /> <path d="M12 16v2" /> <path d="M12 22h.01" />',wind:'<path d="M12.8 19.6A2 2 0 1 0 14 16H2" /> <path d="M17.5 8a2.5 2.5 0 1 1 2 4H2" /> <path d="M9.8 4.4A2 2 0 1 1 11 8H2" />'};function xt(t,e){return W`<svg
  ...
  >${yt(bt[t]??"")}</svg>`}const $t={"clear-night":"moon",cloudy:"cloudy",exceptional:"cloud-lightning",fog:"cloud-fog",hail:"cloud-hail",lightning:"cloud-lightning","lightning-rainy":"cloud-lightning",partlycloudy:"cloud-sun",pouring:"cloud-rain",rainy:"cloud-drizzle",snowy:"cloud-snow","snowy-rainy":"cloud-snow",sunny:"sun",windy:"wind","windy-variant":"wind"};const kt=["blue","cyan","teal","green","violet","magenta","rose"],At=t=>t&&kt.includes(t)?`--cal: var(--cal-${t})`:"",Mt="day-spine-card-fonts";function St(){if(document.getElementById(Mt))return;const t=document.createElement("link");t.id=Mt,t.rel="stylesheet",t.href="https://fonts.googleapis.com/css2?family=Caprasimo&family=Figtree:wght@400;500;600;700&family=Roboto:wght@300;400;500&display=swap",document.head.appendChild(t)}const Et="Past entries stay, struck through, so the day reads as a whole. Sage lines are what the house will do on its own.",Ct={show_all_day:!0,max_all_day:4,show_sources:!0,show_legend:!0,interactive_rows:!1,max_past:3,max_future:6,collapse_low_priority:!0,recent_events:!0,recent_ttl:300,load_fonts:!0,show_clock:!0,show_day:!0,show_headline:!0,show_sun:!0,show_past:!0,show_tags:!0,show_progress:!0,time_format:"auto",show_weather:!0,use_ha_theme:!1,show_duration:!0};class zt extends ht{constructor(){super(...arguments),this._now=Date.now(),this._expanded=!1,this._alldayExpanded=!1,this._pending=new Set}setConfig(t){if(!t?.entity)throw new Error("day-spine-card: `entity` is required (the merged feed sensor).");this._config={...Ct,...t},this._expanded=!1,this._alldayExpanded=!1,this._applyFonts()}_applyFonts(){const t=this._config.font_family,e=this._config.heading_font_family??t;for(const[a,r]of[["--font-body",t],["--font-heading",e]])r?this.style.setProperty(a,r):this.style.removeProperty(a)}set hass(t){this._hass=t;const e=t?.states?.[this._config?.entity];e!==this._stateObj&&e?.last_updated!==this._stateObj?.last_updated?(this._stateObj=e,this._pending=new Set):!e&&this._stateObj&&(this._stateObj=void 0)}connectedCallback(){super.connectedCallback(),this._config?.load_fonts&&St(),this._startClock()}disconnectedCallback(){super.disconnectedCallback(),this._timer&&window.clearInterval(this._timer),this._align&&window.clearTimeout(this._align),this._timer=this._align=void 0}_startClock(){const t=()=>{this._now=Date.now()};this._align=window.setTimeout(()=>{t(),this._timer=window.setInterval(t,6e4)},6e4-Date.now()%6e4)}getCardSize(){return 6}getGridOptions(){return{columns:12,rows:10,min_columns:6,min_rows:4}}static getStubConfig(t){return{type:"custom:day-spine-card",entity:Object.keys(t?.states??{}).find(e=>e.startsWith("sensor.")&&Array.isArray(t?.states[e]?.attributes?.entries))??"sensor.day_spine",use_ha_theme:!0}}render(){const t=this._config,e=this._stateObj,a=!e||"unavailable"===e.state||"unknown"===e.state,r=e?.attributes??{},o=new Intl.DateTimeFormat(this._locale,{weekday:"long",timeZone:this._tz}).format(new Date(this._now));if(a)return F`<div class="card ${t.use_ha_theme?"themed":""}">
      ...
      ${t.map(t=>F`<span
          ...
          >
            ${t.color?F`<i class="swatch"></i>`:G}${t.label}</span
          >`)}
    </div>`}_renderAllDay(t){const e=Math.max(1,this._config.max_all_day),a=t.filter(t=>t.action||"will_fire"===t.tag_state),r=t.filter(t=>!a.includes(t)),o=[...a,...r],i=this._alldayExpanded?0:Math.max(0,o.length-e),n=i?o.slice(0,e):o;return F`<div class="allday">
      ${n.map(e=>{const a=F`${e.title}${this._renderTags(e)}`;return F`<div class="allday-item" style=${At(e.color)}>
          ${xt("calendar-days",18)}
          <div class="allday-body">
            ${this._startedEarlier(e)&&e.end?F`<div>${a}<span class="dur">until ${this._endLabel(e)}</span></div>`:1!==t.length||e.automation||e.action?F`<div>${a}</div>`:F`All day · ${a}`}
            ${e.automation?F`<div class="auto">${xt("sparkles",14)}${e.automation}</div>`:G}
    ...
    </div>`}_renderRow(t){const e=t.entry,a=this._config.interactive_rows&&!!e?.entity_id&&"now"!==t.variant,r=["row",t.variant,t.last?"last":"",t.firstLive?"live-start":"",t.afterLive?"after-live":"",a?"tappable":"",e?.level&&"normal"!==e.level?`lvl-${e.level}`:"",e&&this._pending.has(e.id)?"done":""].filter(Boolean).join(" ");return F`<div
      class=${r}
      style=${At(e?.color)}
      role=${a?"button":G}
      tabindex=${a?0:G}
      @click=${a?()=>this._moreInfo(e.entity_id):G}
      @keydown=${a?t=>this._rowKey(t,e.entity_id):G}
    >
      <div class="t">${t.time}${this._renderWeather(t)}</div>
      <div class="rail"></div>
      <div class="c">${this._renderContent(t)}</div>
    </div>`}_renderTags(t){if(!t.tags?.length||!this._config.show_tags)return G;const e=t.tag_state??"inert";return F`${t.tags.map(t=>F`<span class="tag ${e}">#${t}</span>`)}`}_renderContent(t){const e=t.entry;switch(t.variant){case"now":return F`<div class="now-l">Now</div>
          ${t.subline?F`<div class="now-s">${t.subline}</div>`:G}`;case"past":return F`${e.title}${this._renderTags(e)}`;case"recent":return F`${xt("sparkles",14)}<span>${e.title}</span>`;case"live":return F`<div class="ttl">${e.title}${this._renderTags(e)}</div>
          ${e.automation?F`<div class="auto">${xt("sparkles",14)}${e.automation}</div>`:G}
          ${this._renderProgress(t)} ${this._renderAction(e)}`;default:{const t=this._config.show_duration?this._duration(e):null;return F`<div class="ttl">
            ${this._renderLevel(e)}${e.title}${this._renderTags(e)}${t?F`<span class="dur">${t}</span>`:G}
          </div>
          ${e.automation?F`<div class="auto">${xt("sparkles",14)}${e.automation}</div>`:G}
          ${this._renderAction(e)}`}}}_renderLevel(t){return"alert"===t.level?F`${xt("triangle-alert",15)}`:"info"===t.level?F`${xt("info",15)}`:G}_renderWeather(t){const e=t.entry?.weather;if(!this._config.show_weather||!e||"future"!==t.variant)return G;if(void 0===e.condition&&void 0===e.temperature)return G;const a=e.precipitation_probability,r=e.precipitation,o="number"==typeof a&&a>=40||"number"!=typeof a&&"number"==typeof r&&r>0,i="number"==typeof a?`${Math.round(a)}% chance of precipitation`:"number"==typeof r&&r>0?`${r} mm of precipitation forecast`:G;return F`<div class="wx ${o?"wet":""}" title=${i}>
      ${n=e.condition,s=13,xt($t[n??""]??"cloud",s)}
      ${void 0!==e.temperature?F`<span>${Math.round(e.temperature)}°</span>`:G}
    </div>`;var n,s}_renderProgress(t){if(!this._config.show_progress)return G;const e=Math.round(100*(t.progress??0));return F`<div class="prog">
    ...
    </div>`}_renderAction(t){const e=t.actions?.length?t.actions:t.action?[t.action]:[];if(!e.length)return G;const a=this._pending.has(t.id);return F`<div class="acts">
      ${e.slice(0,2).map((e,r)=>F`<button
          class="act ${r?"act-alt":""}"
          ?disabled=${a}
          @click=${a=>{a.stopPropagation(),this._act(t,e)}}
        >
          ${r?G:xt("check",14)}${e.label}
        </button>`)}
...
`,Dt={show_date:!0,show_next:!0,max_alerts:2,quiet_message:"Nothing else today",inset_bottom:0,inset_top:0,time_format:"auto",load_fonts:!0,use_ha_theme:!1};class Pt extends ht{constructor(){super(...arguments),this._now=Date.now(),this._pending=new Set,this._fit=0,this._box={h:0,w:0}}setConfig(t){if(!t?.entity)throw new Error("dayline-glance-card: `entity` is required (the merged feed sensor).");this._config={...Dt,...t},this._fit=0,this._applyFonts(),this._applyInsets()}_applyInsets(){const t=this._config.max_height;t&&/^[0-9.]+(px|em|rem|vh|svh|dvh|lvh|%)$/.test(t.trim())?this.style.setProperty("--glance-max-height",t.trim()):this.style.removeProperty("--glance-max-height");for(const[t,e]of[["--inset-bottom",this._config.inset_bottom],["--inset-top",this._config.inset_top]]){const a=Number(e);Number.isFinite(a)&&a>0?this.style.setProperty(t,`${a}px`):this.style.removeProperty(t)}}_applyFonts(){const t=this._config.font_family,e=this._config.heading_font_family??t;for(const[a,r]of[["--font-body",t],["--font-heading",e],["--font-clock",this._config.clock_font_family]])r?this.style.setProperty(a,r):this.style.removeProperty(a)}set hass(t){this._hass=t;const e=t?.states?.[this._config?.entity];e!==this._stateObj&&e?.last_updated!==this._stateObj?.last_updated?(this._stateObj=e,this._pending=new Set,this._fit=0):!e&&this._stateObj&&(this._stateObj=void 0)}connectedCallback(){super.connectedCallback(),this._config?.load_fonts&&St(),this._startClock(),"undefined"!=typeof ResizeObserver&&(this._ro=new ResizeObserver(()=>{const t=this.clientHeight,e=this.clientWidth;(t>this._box.h+1||e!==this._box.w)&&(this._fit=0),this._box={h:t,w:e}}),this._ro.observe(this))}disconnectedCallback(){super.disconnectedCallback(),this._timer&&window.clearInterval(this._timer),this._align&&window.clearTimeout(this._align),this._timer=this._align=void 0,this._ro?.disconnect(),this._ro=void 0}updated(){if(this._fit>=6)return;const t=this.renderRoot.querySelector(".card");t&&(t.scrollHeight>t.clientHeight+1||this._overflowsScreen())&&(this._fit+=1)}_overflowsScreen(){const t=this.renderRoot.querySelector(".clock-zone");if(!t)return!1;const e=Array.from(t.children),a=parseFloat(getComputedStyle(t).rowGap)||0,r=e.reduce((t,e)=>t+e.getBoundingClientRect().height,0)+a*Math.max(0,e.length-1);if(t.getBoundingClientRect().height-r>2)return!1;const o=this.getBoundingClientRect(),i=window.innerHeight||0;return!(!i||!o.height||o.top>.4*i)&&o.bottom>i+1}_startClock(){const t=()=>{this._now=Date.now()};this._align=window.setTimeout(()=>{t(),this._timer=window.setInterval(t,6e4)},6e4-Date.now()%6e4)}getCardSize(){return 4}getGridOptions(){return{columns:12,rows:6,min_columns:6,min_rows:3}}static getStubConfig(t){return{type:"custom:dayline-glance-card",entity:Object.keys(t?.states??{}).find(e=>e.startsWith("sensor.")&&Array.isArray(t?.states[e]?.attributes?.entries))??"sensor.day_spine",use_ha_theme:!0}}render(){const t=this._config,e=this._stateObj,a=!e||"unavailable"===e.state||"unknown"===e.state,r=a?[]:this._live(Array.isArray(e.attributes.entries)?e.attributes.entries:[]),o=this._alerts(r).slice(0,this._fit>=5?1:void 0),i=this._next(r,o),n=t.show_next&&this._fit<6,s=t.show_date&&this._fit<3;return F`<div class="card ${t.use_ha_theme?"themed":""} a${o.length} f${this._fit}">
      <div class="clock-zone">
        ${this._renderClock()} ${s?F`<div class="date">${this._dateLine()}</div>`:G}
      </div>
      ${n?this._renderNext(i,a):G}
      ${o.length?F`<div class="alerts">${o.map(t=>this._renderAlert(t))}</div>`:G}
    </div>`}_renderClock(){const t=this._fmt(this._now,!1),e=this._fmt(this._now,!0),a=t.startsWith(e)?t.slice(e.length).trim():"";return F`<div class="clock">
      ${e}${a?F`<span class="mer">${a}</span>`:G}
    </div>`}_dateLine(){return new Intl.DateTimeFormat(this._locale,{weekday:"long",month:"long",day:"numeric",timeZone:this._tz}).format(new Date(this._now))}_renderNext(t,e){if(e)return F`<div class="next"><div class="quiet">Dayline feed unavailable</div></div>`;if(!t)return F`<div class="next"><div class="quiet">${this._config.quiet_message}</div></div>`;const{entry:a,running:r}=t,o=At(a.color);return F`<div class="next">
      <div class="next-when">
      ...
      <div class="next-what">
        <div class="next-title">
          ${o?F`<span class="dot" style=${o}></span>`:G}${a.title}
        </div>
        ${a.automation?F`<div class="next-auto">${a.automation}</div>`:G}
      </div>
    </div>`}_renderAlert(t){const e=(t.actions?.length?t.actions:t.action?[t.action]:[]).slice(0,2),a="info"===t.level?"var(--ds-level-info)":"var(--ds-level-alert)";return F`<div
    ...
    >
      ...
      <div class="alert-body">
        ...
        ${t.automation?F`<div class="alert-sub">${t.automation}</div>`:G}
      </div>
      ${e.length?F`<div class="btns">
            ${e.map((e,a)=>F`<button
                  class=${a?"quiet-btn":""}
                  @click=${()=>this._act(t,e)}
                  ?disabled=${this._pending.has(t.id)}
                >
                  ${0===a?xt("check",18):G}${e.label}
                </button>`)}
          </div>`:G}
